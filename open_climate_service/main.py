...
def _zarr_browser_access_origins() -> set[str]:
    ...
    raw = os.getenv("OPEN_CLIMATE_SERVICE_ZARR_BROWSER_ORIGINS", "https://inspect.geozarr.org")
...
def _pna_trusted_origins() -> set[str]:
    ...
    OPEN_CLIMATE_SERVICE_PNA_ORIGINS environment variable (comma-separated).
    """
    default = "https://editor.openeo.org," + os.getenv(
        "OPEN_CLIMATE_SERVICE_ZARR_BROWSER_ORIGINS", "https://inspect.geozarr.org"
    )
    raw = os.getenv("OPEN_CLIMATE_SERVICE_PNA_ORIGINS", default)
