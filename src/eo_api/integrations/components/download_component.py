"""Download/acquisition component for generic workflow chain."""
...
def component_download(params: dict[str, Any], context: dict[str, Any]) -> dict[str, Any]:
    ...
    if adapter is None:
        raise ProcessorExecuteError(f"Unsupported dataset '{dataset}' in download component")
