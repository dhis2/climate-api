...
The `climate_service.client` module provides a `Client` class for discovering and opening datasets:
...
```python
from climate_service.client import list_datasets, open_dataset  # reads CLIMATE_SERVICE_BASE_URL
