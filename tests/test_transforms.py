...
from climate_service.transforms import kelvin_to_celsius, metres_to_mm
...
class TestRunTransformsPipeline:
    def test_pipeline_via_dotted_path(self):
        ...
        dataset = {
            "variable": "t2m",
            "transforms": ["climate_service.transforms.kelvin_to_celsius"],
        }
        from climate_service.data_manager.services.downloader import _run_transforms
    ...
    def test_dict_entry_with_params(self):
        ...
        dataset = {
            "variable": "t2m",
            "transforms": [{"function": "climate_service.transforms.kelvin_to_celsius"}],
        }
        from climate_service.data_manager.services.downloader import _run_transforms
