...
from climate_service.openeo import collections as collections_service
from climate_service.openeo import processes as processes_service
from climate_service.openeo import udps as udp_store
from climate_service.openeo.capabilities import build_capabilities
from climate_service.openeo.jobs import get_openeo_job_service
from climate_service.openeo.schemas import (
    OpenEOJobCreate,
...
def download_geojson_result(job_id: str) -> FileResponse:
    ...
    from climate_service.openeo.jobs import _JOBS_DIR
...
def execute_synchronous(
    ...
    """
    from climate_service.openeo.execution import run_process_graph
    ...
    from climate_service.openeo.execution import SaveResultEnvelope
    from climate_service.openeo.jobs import _write_raster, _write_vector
