...
This module is imported before any other climate_service modules so that
...
from climate_service.publications.services import PYGEOAPI_CONFIG_PATH, PYGEOAPI_OPENAPI_PATH  # noqa: E402
...
# -- climate_service / third-party logging setup ---------------------------------------
eo_logger = logging.getLogger("climate_service")
