...
from climate_service.data_registry.routes import _get_dataset_or_404
...
def create_ingestion(
    ...
    if _prefer_respond_async(prefer):
        ...
        from climate_service.ingestions.processes import execute_ingestion
...
def sync_dataset(
    ...
    if _prefer_respond_async(prefer):
        ...
        from climate_service.ingestions.processes import execute_sync
        from climate_service.jobs.service import get_job_service
