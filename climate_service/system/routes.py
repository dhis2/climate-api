...
async def manage_ingest(request: Request) -> Response:
    ...
    from climate_service.data_registry.services.datasets import get_dataset
    from climate_service.extents.services import get_extent_or_404
    from climate_service.ingestions.services import create_artifact
...
async def manage_sync(request: Request) -> Response:
    ...
    from climate_service.ingestions.services import sync_dataset
