...
from climate_service.data_accessor.services.accessor import open_zarr_dataset
from climate_service.data_manager.services.utils import get_time_dim, get_x_y_dims
from climate_service.ingestions.schemas import ArtifactFormat, ArtifactRecord, PublicationStatus
...
def publish_artifact(record: ArtifactRecord) -> ArtifactRecord:
    ...
    from climate_service.ingestions.services import list_artifacts
...
def _refresh_mounted_pygeoapi() -> None:
    ...
    try:
        from climate_service.pygeoapi_app import refresh_pygeoapi
    except Exception:
        return
    refresh_pygeoapi()
...
def _load_base_config() -> dict[str, Any]:
    ...
    resource = importlib.resources.files("climate_service") / "data" / "pygeoapi" / "base.yml"
