...
from climate_service.data_manager.services.utils import get_time_dim, get_x_y_dims
...
from climate_service.ingestions.schemas import ArtifactFormat, ArtifactRecord
from climate_service.shared.time import parse_period_string_to_datetime, resolve_iso_period_step
...
def _build_renders(artifact: ArtifactRecord, source_dataset: dict[str, Any]) -> dict[str, Any] | None:
    ...
    render: dict[str, Any] = {
        ...
        "climate_service:variable": artifact.variable,
    }
    ...
    if isinstance(units, str):
        render["climate_service:units"] = units
