...
def file_formats() -> dict[str, Any]:
    ...
    output_formats = {
        "ZARR": {
            "title": "Zarr",
            "description": "Zarr v3 chunked array store — efficient cloud-native format for multi-dimensional raster data",
        ...
        "NETCDF": {
            ...
            "description": "Standard self-describing format for climate and Earth science data, widely supported by CDO, NCO, xarray, R and MATLAB",
            "gis_data_types": ["raster"],
            "parameters": {},
        ...
        "GTIFF": {
            "title": "GeoTIFF",
            "description": "Georeferenced TIFF raster with embedded CRS and spatial metadata, compatible with QGIS, GDAL and most GIS tools",
            "gis_data_types": ["raster"],
            "parameters": {},
        ...
        "GEOJSON": {
            "title": "GeoJSON",
            "description": "Standard JSON encoding of geographic features — default output for vector and zonal statistics results",
        ...
        "CSV": {
            ...
            "description": "Plain text tabular format — suitable for time series, zonal statistics and spreadsheet import",
        ...
        "PARQUET": {
            "title": "GeoParquet",
            "description": "Columnar Apache Parquet format with geometry column — efficient for large vector datasets and analytics",
            "gis_data_types": ["vector"],
            "parameters": {},
